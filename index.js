...
const main = async () => {
  ...
  // console.log(dpm_tensor)
  fs.writeFile(path.join(dest_path, "depth_map_tensor"), dpm_tensor.dataSync(), 'utf8', (err) => {
    if (err)
      console.log(`An error occurred while saving the tensor file. The error is as follows. \n${err}`);
    else
